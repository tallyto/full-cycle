...
import (
	...
	application "github.com/tallyto/full-cycle/hexagonal/application"
)
...
func (m *MockProductWriter) Save(product application.ProductInterface) error {
	m.ctrl.T.Helper()
...
func (m *MockProductWriter) Update(product application.ProductInterface) error {
	m.ctrl.T.Helper()
...
func (mr *MockProductWriterMockRecorder) Update(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockProductWriter)(nil).Update), product)
}
...
// Save mocks base method.
func (m *MockProductPersistenceInterface) Save(product application.ProductInterface) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(error)
	return ret0
...
// Update mocks base method.
func (m *MockProductPersistenceInterface) Update(product application.ProductInterface) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", product)
	ret0, _ := ret[0].(error)
	return ret0
